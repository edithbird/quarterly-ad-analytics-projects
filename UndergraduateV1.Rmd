---
title: "FA20 Undergraduate Campaign Quarterly Ad Analytics Project: FY20 Q1"
...
```{r}
NewDataFY19Q1 <- NewData %>% filter(Quarter == "FY20Q1" & str_detect(Ad, "HS"))
NewDataFY19Q1 <- NewDataFY19Q1[,c(4:11)]
knitr::kable(NewDataFY19Q1, "latex", caption = "FY20 Q1 Campaign to HS Students", booktabs = T)%>%
kable_styling(full_width = T)  %>%
  row_spec(0, angle = -45)
```

```{r}
NewDataFY19Q1 <- NewData %>% filter(Quarter == "FY20Q1" & str_detect(AdSet, "FA20_UG_IN_PIN_DISP_BR"))
NewDataFY19Q1 <- NewDataFY19Q1[,c(4:11)]
knitr::kable(NewDataFY19Q1, "latex", caption = "FY20 Q1 Campaign to Influencers", booktabs = T)%>%
kable_styling(full_width = T)  %>%
  row_spec(0, angle = -45)
```