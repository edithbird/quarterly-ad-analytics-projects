---
title: "FA Undergraduate Campaign Quarterly Ad Analytics Project: FY19 Q1"
...
```{r}
NewDataFY19Q1 <- NewData %>% filter(Quarter == "FY19Q1" & str_detect(AdSet, "FA19_UG_IN_PIN_DISP_BR"))
NewDataFY19Q1 <- NewDataFY19Q1[,c(4:11)]
