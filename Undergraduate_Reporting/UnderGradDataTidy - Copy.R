...
FM <- FM %>%
  filter(Code_Product == "UG" & Code_Objective %in% objective & Code_Audience != "TL") %>% 
  mutate(
...
write.csv(NewData, "C:/Users/christine.iyer/Box/quarterly-ad-analytics-projects/FlowchartHS_V2.csv", row.names = F)
