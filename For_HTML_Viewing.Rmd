...
![](C:/Users/christine.iyer/Pictures/Logo.jpg)
...
NewData1 <- NewData1 %>% 
  mutate(CTR = as.numeric(CTR),
        ...
        # hms("12:34:45") - hms("00:00:00")
         #Av_TOP = mean(times(Av_TOP)), 
        Av_TOP = as.numeric(hms(Av_TOP)))
...
spec_1 <- build_wider_spec(NewData2,
            names_from = Quarter, 
            values_from = c(Impressions:Av_TOP))
...
# Product/Audience {.tabset .tabset-pills}

## High School Students {.tabset}
...
kable(nD4 %>% 
    ...
    mutate_at(vars(c("FY19Q1", "FY19Q2", "FY19Q3", "FY19Q4","FY20Q1", "FY20Q2", "FY20Q3", "FY20Q4")), ~ifelse( . == "0", "~", .))) %>% 
...
kable(nD4 %>% 
        filter(Campaign == "HS") %>% 
        select(AdSets, Cost_FY19Q1:Cost_FY20Q4) %>% 
        mutate(
          Cost_FY19Q1 = paste0("$",prettyNum(Cost_FY19Q1, big.mark = ",")),
          Cost_FY19Q2 = paste0("$",prettyNum(Cost_FY19Q2, big.mark = ",")),
          Cost_FY19Q3 = paste0("$",prettyNum(Cost_FY19Q3, big.mark = ",")),
          Cost_FY19Q4 = paste0("$",prettyNum(Cost_FY19Q4, big.mark = ",")),
          Cost_FY20Q1 = paste0("$",prettyNum(Cost_FY20Q1, big.mark = ",")),
          Cost_FY20Q2 = paste0("$",prettyNum(Cost_FY20Q2, big.mark = ",")),
          Cost_FY20Q3 = paste0("$",prettyNum(Cost_FY20Q3, big.mark = ",")),
          Cost_FY20Q4 = paste0("$",prettyNum(Cost_FY20Q4, big.mark = ","))) %>% 
        rename(AdSet = AdSets,FY19Q1 = Cost_FY19Q1, FY19Q2 = Cost_FY19Q2, FY19Q3 = Cost_FY19Q3, FY19Q4 = Cost_FY19Q4, FY20Q1 = Cost_FY20Q1, FY20Q2 = Cost_FY20Q2, FY20Q3 = Cost_FY20Q3, FY20Q4 = Cost_FY20Q4)%>%
    mutate_at(vars(c("FY19Q1", "FY19Q2", "FY19Q3", "FY19Q4","FY20Q1", "FY20Q2", "FY20Q3", "FY20Q4")), ~ifelse( . == "$0", "~", .)))  %>% 
  kable_styling("striped")  %>%
...
kable(nD4 %>% 
        filter(Campaign == "HS") %>% 
        select(AdSets, Av_TOP_FY19Q1:Av_TOP_FY20Q4) %>% 
        mutate(
          Av_TOP_FY19Q1 = prettyNum(Av_TOP_FY19Q1, big.mark = ","),
          Av_TOP_FY19Q2 = prettyNum(Av_TOP_FY19Q2, big.mark = ","),
          Av_TOP_FY19Q3 = prettyNum(Av_TOP_FY19Q3, big.mark = ","),
          Av_TOP_FY19Q4 = prettyNum(Av_TOP_FY19Q4, big.mark = ","),
          Av_TOP_FY20Q1 = prettyNum(Av_TOP_FY20Q1, big.mark = ","),
          Av_TOP_FY20Q2 = prettyNum(Av_TOP_FY20Q2, big.mark = ","),
          Av_TOP_FY20Q3 = prettyNum(Av_TOP_FY20Q3, big.mark = ","),
          Av_TOP_FY20Q4 = prettyNum(Av_TOP_FY20Q4, big.mark = ",")) %>% 
        rename(AdSet = AdSets,FY19Q1 = Av_TOP_FY19Q1, FY19Q2 = Av_TOP_FY19Q2, FY19Q3 = Av_TOP_FY19Q3, FY19Q4 = Av_TOP_FY19Q4, FY20Q1 = Av_TOP_FY20Q1, FY20Q2 = Av_TOP_FY20Q2, FY20Q3 = Av_TOP_FY20Q3, FY20Q4 = Av_TOP_FY20Q4)%>%
    mutate_at(vars(c("FY19Q1", "FY19Q2", "FY19Q3", "FY19Q4","FY20Q1", "FY20Q2", "FY20Q3", "FY20Q4")), ~ifelse( . == "0", "~", .))) %>% 
  kable_styling("striped")  %>%
...
## Current Undergraduates for Transfer{.tabset}
...
kable(nD4 %>% 
  ...
  pack_rows("Video", 7, 10) %>% 
  add_header_above(c(" " = 1, "FY19" = 4, "FY20" = 4)) %>% 
  add_header_above(c(" " = 1, "Average Time on Page" = 8))
```
...
## Degree Completion Program {.tabset}
...
## Out-of-State High School Students{.tabset}
...
## Tours:High School Students{.tabset}
...
kable(nD4 %>% 
        ...
        rename(AdSet = AdSets, 
               ...
               FY20Q3 = Impressions_FY20Q3, 
               FY20Q4 = Impressions_FY20Q4) %>%
    mutate_at(vars(c("FY19Q3", "FY19Q4","FY20Q3", "FY20Q4")), ~ifelse( . == "0", "~", .))) %>% 
  kable_styling("striped")  %>%
  pack_rows("Carousel", 1,2) %>% 
  pack_rows("Display", 3, 6) %>%
  pack_rows("Video",7, 9) %>% 
