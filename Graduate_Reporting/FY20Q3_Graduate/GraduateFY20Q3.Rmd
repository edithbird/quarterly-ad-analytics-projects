...
The FY20 advertising campaign for the University's Graduate program has been multiphasic; part III (using the new creative and landing page) started midway through the 3rd quarter. The Q3 portfolio consists of Programmatic display, Facebook video, and LinkedIn Inbox. Transition from /here to /excel has been seemless. It is difficult to speculate as to how Covid-19 may have impacted campaign performance, nevertheless, it is important to note that the social distancing due to the global pandemic became mandatory for the entire third month of the quarter. 
