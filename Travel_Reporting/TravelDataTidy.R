...
FM <- FM %>%
  filter(Code_Audience == "TL" & Master_Date != "") %>% 
  mutate(
...
write.csv(NewData, "C:/Users/christine.iyer/Box/quarterly-ad-analytics-projects/FlowchartTravel.csv", row.names = F)
