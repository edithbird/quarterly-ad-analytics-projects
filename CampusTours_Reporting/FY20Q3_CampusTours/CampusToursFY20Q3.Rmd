...
kable_styling(full_width = T)  %>%
 row_spec(0, angle = -45)%>%
  ...
  pack_rows("Video", 4, 5)
```
* The advertising campaign for campus tours has performed very well this quarter. Despite the COVID-19 mandate to quarentine, bringing March attendance to nearly zero, campus tour's confirmed registrants in January and February, 2020, exceeded that of the entire Q3 in FY19.
